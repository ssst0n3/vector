            ...
            <div className="nav-items">
              ...
              >
                <svg aria-hidden="true" className="nav-icon" viewBox="0 0 24 24" fill="none">
                  <path d="M4.5 10.5L12 4L19.5 10.5V19.25H14.5V14H9.5V19.25H4.5V10.5Z" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              ...
              >
                <svg aria-hidden="true" className="nav-icon" viewBox="0 0 24 24" fill="none">
                  <path d="M3.75 6.75C3.75 5.79 4.54 5 5.5 5H10L12 7H18.5C19.46 7 20.25 7.79 20.25 8.75V17.25C20.25 18.21 19.46 19 18.5 19H5.5C4.54 19 3.75 18.21 3.75 17.25V6.75Z" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              ...
              >
                <svg aria-hidden="true" className="nav-icon" viewBox="0 0 24 24" fill="none">
                  <path d="M12 8.2A3.8 3.8 0 1 1 8.2 12A3.8 3.8 0 0 1 12 8.2ZM19 12A7.1 7.1 0 0 0 18.93 11L21 9.55L19.5 6.95L17.04 7.7A7.2 7.2 0 0 0 15.3 6.68L15 4H9L8.7 6.68A7.2 7.2 0 0 0 6.96 7.7L4.5 6.95L3 9.55L5.07 11A7.1 7.1 0 0 0 5 12C5 12.34 5.02 12.67 5.07 13L3 14.45L4.5 17.05L6.96 16.3A7.2 7.2 0 0 0 8.7 17.32L9 20H15L15.3 17.32A7.2 7.2 0 0 0 17.04 16.3L19.5 17.05L21 14.45L18.93 13A7.1 7.1 0 0 0 19 12Z" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
                                  ...
                                  <article key={`${activeDrillPath.join('-')}-center-overview`} className="ow64-overview-panel is-center">
                                    <div className="ow64-mini-grid">
                                      {PILLAR_GRID_LAYOUT.map((gridItem) => {
                                        ...
                                        const isCenterCell = gridItem.type === 'center'

                                        return (
                                          isCenterCell ? (
                                            <button
                                              key={`${activeDrillPath.join('-')}-self-center`}
                                              type="button"
                                              className={`ow64-mini-cell ow64-mini-cell-trigger is-core ${isVisible ? '' : 'is-empty'}`}
                                              title="打开当前层九宫格"
                                              aria-label="打开当前层九宫格"
                                            ...
                                            <div
                                              key={`${activeDrillPath.join('-')}-self-${gridItem.actionId}`}
                                              className={`ow64-mini-cell ${isVisible ? '' : 'is-empty'}`}
                                            >
                                              {isVisible && (
                                                <>
                                  ...
                                  <div className="ow64-mini-grid">
                                    {PILLAR_GRID_LAYOUT.map((gridItem) => {
                                      ...
                                      return (
                                        isCenterCell ? (
                                          <button
                                            key={`${activeDrillPath.join('-')}-${actionId}-center`}
                                            type="button"
                                            className={`ow64-mini-cell ow64-mini-cell-trigger is-core ${isVisible ? '' : 'is-empty'}`}
                                          ...
                                          <div
                                            key={`${activeDrillPath.join('-')}-${actionId}-${gridItem.actionId}`}
                                            className={`ow64-mini-cell ${isVisible ? '' : 'is-empty'}`}
                                          >
                                            {isVisible && (
                                              <>
                                  ...
                                  <article key={layoutCellId} className="ow64-overview-panel is-center">
                                    <div className="ow64-mini-grid">
                                      {ROOT_CELLS.map((cell) => {
                                        ...
                                        const isCenterCell = cell.id === 'objective'
                                    ...
                                    {PILLAR_GRID_LAYOUT.map((gridItem) => {
                                      ...
                                      return (
                                        isCenterCell ? (
                                          ...
                                          <div
                                            key={`${pillarId}-${gridItem.actionId}`}
                                            className={`ow64-mini-cell ${isVisible ? '' : 'is-empty'}`}
                                          >
                                            {isVisible && (
                                              <>
